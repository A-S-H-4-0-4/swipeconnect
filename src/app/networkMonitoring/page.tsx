        ...
        <Header/>
            ...
            <div className="p-6 py-10   md:px-5 md:py-10 ">
                ...
                <p className="text-lg text-justify  p-5 font-semibold">
                    Our Network Monitoring solution offers comprehensive visibility and control over your organization&apos;s network infrastructure, empowering you to optimize performance, ensure uptime, and proactively detect and mitigate potential security threats. With advanced monitoring capabilities and real-time insights, you can stay one step ahead, delivering a reliable and secure network environment.    </p>
